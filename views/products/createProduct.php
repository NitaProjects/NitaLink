...
<html lang="es">
    ...
    <body>
        ...
        <main>
            ...
            <form id="productForm" action="../../../controllers/productsControllers/newPhysicalBookController.php" method="POST">
                ...
                <div id="bookInfo" class="form-group">
                    <div id="bookCommonInfo">
                        ...
                        <input type="text" id="publish_date" name="publish_date" placeholder="dd/mm/yyyy">
                        <label for="availability_date">Fecha de Disponibilidad:</label>
                        <input type="text" id="availability_date" name="availability_date" placeholder="dd/mm/yyyy h:m:s">
